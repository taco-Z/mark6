...
my %DEFAULTS = (
    ja => {
        ...
        'admin.settings.ai_provider'     => 'AIプロバイダー',
        'admin.settings.ai_provider_openai' => 'OpenAI',
        'admin.settings.ai_model'        => 'AIモデル',
        'admin.settings.ai_api_key_env'  => 'APIキー環境変数名',
        'admin.settings.ai_api_key_env_help' => 'APIキー本体ではなく、サーバに設定した環境変数の名前です。',
        ...
        'admin.ai.legend'                => 'AI支援',
        'admin.ai.help'                  => '記事を保存し、概要、SEO説明、タグ候補を生成します。',
        'admin.ai.generate'              => 'AI提案を生成',
        'admin.ai.done'                  => 'AI提案を生成しました。',
        'admin.ai.summary'               => '概要',
        'admin.ai.seo_description'       => 'SEO説明',
        'admin.ai.suggested_tags'        => 'タグ候補',
        'admin.ai.last_processed_at'     => '最終生成日時',
        'admin.ai.disabled_error'        => 'AI支援が無効です。',
    ...
    en => {
        ...
        'admin.settings.ai'              => 'AI',
        'admin.settings.ai_provider'     => 'AI provider',
        'admin.settings.ai_provider_openai' => 'OpenAI',
        'admin.settings.ai_model'        => 'AI model',
        'admin.settings.ai_api_key_env'  => 'API key environment variable name',
        'admin.settings.ai_api_key_env_help' => 'Enter the server environment variable name, not the API key itself.',
        ...
        'admin.ai.legend'                => 'AI assist',
        'admin.ai.help'                  => 'Save the article and generate summary, SEO description, and tag suggestions.',
        'admin.ai.generate'              => 'Generate AI suggestions',
        'admin.ai.done'                  => 'AI suggestions were generated.',
        'admin.ai.summary'               => 'Summary',
        'admin.ai.seo_description'       => 'SEO description',
        'admin.ai.suggested_tags'        => 'Suggested tags',
        'admin.ai.last_processed_at'     => 'Last processed',
        'admin.ai.disabled_error'        => 'AI assist is disabled.',
