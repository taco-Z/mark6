...
my %DEFAULTS = (
    ja => {
        ...
        'admin.dashboard.access_title'   => 'アクセス概要',
        'admin.dashboard.today_views'    => '今日の閲覧',
        'admin.dashboard.week_views'     => '直近7日間',
        'admin.dashboard.logged_views'   => '記録済み閲覧',
        'admin.dashboard.popular_articles' => 'よく読まれた記事',
        'admin.dashboard.no_access_data' => 'アクセスデータはまだありません。',
        'admin.dashboard.views'          => '閲覧',
        ...
        'admin.article.image_path'       => '画像URL / パス',
        ...
        'admin.settings.ai_api_key_file' => 'APIキーファイルパス',
        'admin.settings.ai_api_key_file_help' => '任意。Web公開外に置いたAPIキーファイルを指定します。',
        ...
        'admin.ai.draft'                 => '本文下書き',
        'admin.ai.translate'             => '翻訳',
        'admin.ai.rewrite'               => 'リライト',
        'admin.ai.seo'                   => 'SEO診断',
        'admin.ai.seo_rewrite'           => 'SEO改善リライト',
        'admin.ai.add_tags'              => 'タグ候補を追加',
        'admin.ai.apply'                 => '記事に反映',
        'admin.ai.target_lang'           => '翻訳先の言語',
        'admin.ai.draft_done'            => '本文下書きを生成しました。内容を確認してから反映できます。',
        'admin.ai.translate_done'        => '翻訳を生成しました。内容を確認してから反映できます。',
        'admin.ai.rewrite_done'          => 'リライト案を生成しました。内容を確認してから反映できます。',
        'admin.ai.seo_done'              => 'SEO診断を生成しました。',
        'admin.ai.seo_rewrite_done'      => 'SEO改善リライト案を生成しました。内容を確認してから反映できます。',
        'admin.ai.tags_applied'          => 'タグ候補を既存タグへ追加しました。',
        'admin.ai.applied'               => 'AIの生成結果を記事に反映しました。',
    ...
    en => {
        ...
        'admin.dashboard.access_title'   => 'Access overview',
        'admin.dashboard.today_views'    => 'Today',
        'admin.dashboard.week_views'     => 'Last 7 days',
        'admin.dashboard.logged_views'   => 'Logged views',
        'admin.dashboard.popular_articles' => 'Popular articles',
        'admin.dashboard.no_access_data' => 'No access data yet.',
        ...
        'admin.article.image_path'       => 'Image URL / path',
        ...
        'admin.settings.ai_api_key_file' => 'API key file path',
        'admin.settings.ai_api_key_file_help' => 'Optional. Keep this file outside the public web directory.',
        ...
        'admin.ai.draft'                 => 'Body draft',
        'admin.ai.translate'             => 'Translate',
        'admin.ai.rewrite'               => 'Rewrite',
        'admin.ai.seo'                   => 'SEO diagnosis',
        'admin.ai.seo_rewrite'           => 'SEO rewrite',
        'admin.ai.add_tags'              => 'Add suggested tags',
        'admin.ai.apply'                 => 'Apply to article',
        'admin.ai.target_lang'           => 'Translation language',
        'admin.ai.draft_done'            => 'Body draft generated. Review it before applying.',
        'admin.ai.translate_done'        => 'Translation generated. Review it before applying.',
        'admin.ai.rewrite_done'          => 'Rewrite generated. Review it before applying.',
        'admin.ai.seo_done'              => 'SEO diagnosis generated.',
        'admin.ai.seo_rewrite_done'      => 'SEO rewrite generated. Review it before applying.',
        'admin.ai.tags_applied'          => 'Suggested tags were added to the article.',
        'admin.ai.applied'               => 'AI result applied to the article.',
